...
export interface Dialect {
  ...
  // How this host takes one line of extra context on stdout, in the shape its
  // hook contract reads. Absent means the host has no such door, and the
  // session-context pull never runs for it.
...
async function pullSessionContext(
  ...
  if (output === undefined || sessionId === "") return undefined;
